    ...
    <AnimatePresence>
      ...
      >
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 0%, ${nodeColor}15 0%, transparent 60%)`,
          }}
        />
        ...
        >
          <div className="flex items-center gap-3">
            <motion.div
              ...
              style={{
                background: `linear-gradient(135deg, ${nodeColor}30, ${nodeColor}10)`,
                boxShadow: `0 0 20px ${nodeColor}20`,
              }}
              whileHover={{ scale: 1.05 }}
            >
              {isProblem ? <Target size={18} style={{ color: nodeColor }} /> : <Lightbulb size={18} style={{ color: nodeColor }} />}
            </motion.div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5 relative">
            ...
            >
              ...
              <div className={`h-2 rounded-full overflow-hidden ${darkMode ? 'bg-zinc-800' : 'bg-gray-200'}`}>
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${nodeColor}, ${nodeColor}80)`,
          ...
          {relatedPapers.length > 0 && (
            ...
            >
              ...
              <div className="space-y-2">
                {relatedPapers.slice(0, 5).map((paper, i) => (
                  <motion.div
                    key={paper.id}
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
